    ...
    <header className="fixed top-0 h-24 w-full p-4 bg-gradient-to-r from-[#006687] to-[#3C1E46] flex items-center justify-between z-50">
      ...
      <span className="w-72 flex justify-around">
        <button
          ...
          className="guide-button inline-flex w-fit justify-center rounded-md bg-black bg-opacity-20 px-4 py-2 text-sm font-medium text-white hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75"
        >
          Network Guide
          <BookOpenIcon
